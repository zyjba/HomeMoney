...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
            function check()
            {
                 var userPwReal="${sessionScope.user.user_password}";
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/img/allbg.gif'>
		...
		<form method="post" action="ModifyServlet?userName=${sessionScope.user.user_account }" name="formPw">
			...
			<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
				...
				<tr bgcolor="#FFFFFF">
				    ...
				    <td width="75%" bgcolor="#FFFFFF">
				        <input type="text" value="${sessionScope.user.user_account }" name="userName" size="22" disabled="disabled"/>
				    </td>
				</tr>
				<tr bgcolor="#FFFFFF">
				    <td width="25%" bgcolor="#FFFFFF" align="right">
