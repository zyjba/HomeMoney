	    ...
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/userPw.jsp' target='main'>修改个人信息</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/auser/Income/IncomeAdd.jsp' target='main'>收入信息添加</a> </li>
	            <li><a href='<%=path %>/ShowServlet?type=income&page=1' target='main'>收入信息管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/auser/Expense/ExpenseAdd.jsp' target='main'>消费信息添加</a> </li>
	            <li><a href='<%=path %>/ShowServlet?type=expense&page=1' target='main'>消费信息管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
				<%--<li><a href='<%=path %>/auser/Statement/all.jsp' target='main'>总体收支分析</a> </li>--%>
	            <li><a href='<%=path %>/auser/Statement/month.jsp' target='main'>每月收支细分</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
